...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & teks utama menggunakan warna Biru Toska (#008B8B) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #008B8B}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#008B8B;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#008B8B;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#008B8B;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone toska muda (#F0F8F8) */
    '.info-box{background:#F0F8F8;border:1px solid #C8E6E6;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Biru Toska (#008B8B) */
    '.paket-box{background:#008B8B;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#F7FCFC;border:1px solid #D5EDED;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft toska (#E6F4F4) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#E6F4F4;border:1px solid #B2E0E0;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#006666;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #C8E6E6;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
